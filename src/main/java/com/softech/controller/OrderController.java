...
import com.softech.repository.OrderRepository;
import com.softech.resource.OrderResource;
import com.softech.resource.OrderResourceAssembler;
...
public class OrderController {
    ...
    private ResponseEntity<OrderResource> createOrder(@RequestBody Order order){
    ...
    public ResponseEntity<Void> deleteOrder(@PathVariable Long id){
        boolean wasDelete = repository.delete(id);
        HttpStatus responseStatus = wasDelete ? HttpStatus.NO_CONTENT : HttpStatus.NOT_FOUND;
